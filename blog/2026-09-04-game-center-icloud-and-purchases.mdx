---
description: "Balaur blog: one platform module over every store (sign-in, achievements, leaderboards, cloud saves), with Game Center, iCloud and StoreKit behind it."
...
- Arrivals. Notifications, push tokens, URLs opened, a purchase that
  landed on another device. Call `apple::watch(node)`, and they reach that
  node.
