---
description: "Balaur devlog: one Plugin trait. Linked in behind a cargo feature it is a module; built as a shared library in a project's extensions/ directory it is an extension, in Rust or in C."
