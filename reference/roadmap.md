...
| **Godot import** — `balaur import` over `project.godot`, `.tscn`, `.tres` and `.gdshader`, writing scenes, assets and a report naming what did not convert. | 0.2 | [PLAN-godot-import.md](PLAN-godot-import.md) |
