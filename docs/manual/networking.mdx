...
deterministic given the same recorded arrivals. One limit: an async entry point
...
other way: the engine calls a method the script declares by name. Most also
