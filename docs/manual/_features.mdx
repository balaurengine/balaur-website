...
`--no-default-features --features audio,http,websocket,gamend,web,window` and links 383 crates.
...
| `window` | off | on | Windowed rendering (kiss3d/wgpu). | `egui-wgpu`, `exr`, `glow`, `kiss3d`, `naga`, `wgpu`, … (67 crates) |
