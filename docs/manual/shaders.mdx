...
<Clip name="shader_preview" alt="A material in the inspector, its shader in the code editor, three lines' values drawn in the viewport, a channel view, and a save that relinks the sprite" />
