...
description: "Records what a running game is fed and plays it back. A recording holds each tick's input, network arrivals and events; balaur run --record writes one."
