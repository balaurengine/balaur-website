...
description: "Rollback netcode from a script's side. input reads this tick's input, real or predicted; is_resimulating is true when a tick runs again after a late input."
