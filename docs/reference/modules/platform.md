...
description: "Store services every platform shares: sign-in, achievements, leaderboards, cloud saves. A call answers later on on_platform with a map whose kind is…"
