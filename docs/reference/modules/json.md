...
sidebar_label: "json"
description: "JSON text to and from script values. Its null keeps nil through a round trip."
...
JSON text to and from script values. Its `null` keeps nil through a round trip.
