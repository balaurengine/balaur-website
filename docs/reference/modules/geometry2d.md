...
description: "Polygons on the plane as lists of [x, y] points in outline order: triangulation, booleans, hulls and containment. Every answer is identical on every…"
