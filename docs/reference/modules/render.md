...
| `color(node) -> float, float, float, float` | [`shape3d`](../components/shape3d.md), [`shape2d`](../components/shape2d.md), [`sprite`](../components/sprite.md), [`polygon`](../components/polygon.md) | The node's tint as r, g, b, a channel floats; opaque white when the node draws nothing at all. |
...
| `set_color(node, float, float, float, float?)` | [`sprite`](../components/sprite.md), [`shape2d`](../components/shape2d.md), [`shape3d`](../components/shape3d.md), [`polygon`](../components/polygon.md), [`particles`](../components/particles.md) | Tint whatever the node draws, as r, g, b channel floats and an optional alpha, one meaning opaque. |
