...
sidebar_label: "apple"
description: "Apple services beyond platform.: Game Center identity, purchases, notifications. Calls answer on a later tick as a kind map, to the node's on_apple or…"
