...
sidebar_label: "web"
description: "The page a browser build runs in; off the web every query answers nil. A parent-frame message reaches on_web_message on every node that called listen."
