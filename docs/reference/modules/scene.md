...
sidebar_label: "scene"
description: "The node tree: its root, lookup by path, spawning and instancing, plus the component and preset vocabulary an editor's palette lists."
...
The node tree: its root, lookup by path, spawning and instancing, plus the component and preset vocabulary an editor's palette lists.

23 functions, 0 constants. Scripts reach it as `scene::`.
