...
description: "The 3D twin of modifier2d, over bone3d: look_at, two_bone_ik, fabrik, ccdik and jiggle, posing bones after the clip has run. A chain solver turns each…"
