...
description: "path3d: A bezier path: points runs anchor, two handles, next anchor, then three more per segment; closed joins the last segment back to the first anchor."
